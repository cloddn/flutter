...
class _LoginPageState extends State<LoginPage> {
  final TextEditingController _emailControlloer=
      TextEditingController(text: 'tndks0770@gmail.com');
  final TextEditingController _passwordControlloer=
  TextEditingController(text: '1234');
  void _onLogin(BuildContext context) {
    final String email=_emailControlloer.text;
              ...
              child: Column( //세로로 배치할 것이니 Column 위젯
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ElevatedButton(onPressed: ()=> _onLogin(context), child: Text('Log In') // 아직 이벤트 처리자 등록하지 않음
                      ),
                      SizedBox(width: 10.0),
